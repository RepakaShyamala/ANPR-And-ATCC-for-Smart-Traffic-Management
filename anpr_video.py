...
def start_anpr(input_files):
    ...
    model = OCR(
    modelFile=r"C:\Users\LENOVO\OneDrive\Desktop\sam_ANPR AND ATCC PRO\binary_128_0.50_ver3 (1).pb",
    labelFile=r"C:\Users\LENOVO\OneDrive\Desktop\sam_ANPR AND ATCC PRO\binary_128_0.50_labels_ver2.txt"
)
...
if __name__ == "__main__":
	video_file=[r"c:\Users\LENOVO\OneDrive\Desktop\anpr.videos\Automatic Number Plate Recognition (ANPR) _ Vehicle Number Plate Recognition (1).mp4"]
